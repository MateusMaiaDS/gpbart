...
saveRDS(object = simple_K_example,
        file = paste0("run_benchmark/CORRECTED_new_rotation_FINAL_scale_gp_spatial_parallel_march_baltimore_gpbart_mod_result_",N,"_K_",K,"_beta_",round(beta,0),"_phi_sample_",
                      phi_sample,
