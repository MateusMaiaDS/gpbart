...
# 
# # Running the model
# gpbart_mod <- gpbart::gp_bart(x = x,y = y,number_trees = 10,kappa = 0.5,
#                               beta = 20,alpha = 0.9,rotation = FALSE)
...
# 
# plot(x,y,pch=20)
# # points(x,unnormalize_bart(rBart_model$y_hat,a = rBart_model$a_min,b = rBart_model$b_max) %>% colMeans())
