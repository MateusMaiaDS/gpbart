...
# Database
database <- readRDS("run_benchmark/data/sim_dataset_1000.Rds")
...
saveRDS(object = simple_K_example,
        file = paste0("robust_kmeans_FIX_PHI_with_gp_no_rotation_FINAL_gpbart_",N,"_K_",K,"_beta_",round(beta,0),"_phi_sample_",
                      phi_sample,
